<%@ Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.PS.UserControls.ShippingBillingCreditForm" CodeBehind="ShippingBillingCreditForm.ascx.cs" %>
...
<asp:UpdatePanel runat="server" ID="upBillingForm">
    <ContentTemplate>
        ...
        <div class="PSontent_B clearfix" style="margin-top: 35px;">
