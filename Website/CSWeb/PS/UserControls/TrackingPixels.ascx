<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TrackingPixels.ascx.cs" Inherits="CSWeb.PS.UserControls.TrackingPixels" %>
<!-- All Pixels Here -->
...
id="wa_u" defer></script><script type="text/javascript" async>                                         //<![CDATA[
                                ...
                                wa_MultivariateKey = 'PS';    //  Set this variable to perform multivariate testing
