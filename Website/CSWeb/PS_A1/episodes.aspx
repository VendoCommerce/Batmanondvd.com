<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="episodes.aspx.cs" Inherits="CSWeb.PS_A1.episodes" EnableSessionState="True" %>
                ...
                <div class="season_a">
                    ...
                    <div class="season_txt">
                        <ol class="episode_details" style="counter-reset: item 80;">
                            ...
                            <li><strong class="episode_title">Batman PS_A1s His Knowledge</strong> <span class="episode_date">(Original Airdate: February 23, 1967)</span><br />
