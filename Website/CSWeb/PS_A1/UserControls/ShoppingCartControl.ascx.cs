...
namespace CSWeb.PS_A1.UserControls
{
    public partial class ShoppingCartControl : System.Web.UI.UserControl
    {
        ...
        public ShoppingCartPS_A1TotalMode TotalMode
        {
            get 
            {
                return ViewState["TotalMode"] == null ? ShoppingCartPS_A1TotalMode.Full : (ShoppingCartPS_A1TotalMode)ViewState["TotalMode"];
            }
            set 
            {
		...
		{
			base.OnPreRender(e);
			holderTaxAndShipping.Visible = TotalMode == ShoppingCartPS_A1TotalMode.Full;
		}
    ...
    public enum ShoppingCartPS_A1TotalMode
    { 
        SubtotalOnly,
        Full
    }
