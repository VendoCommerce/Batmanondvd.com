<%@ Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.PS_A1.UserControls.ShippingBillingCreditForm" CodeBehind="ShippingBillingCreditForm.ascx.cs" %>
...
<asp:UpdatePanel runat="server" ID="upBillingForm">
    <ContentTemplate>
        ...
        <div class="PS_A1ontent_B clearfix" style="margin-top: 35px;">
