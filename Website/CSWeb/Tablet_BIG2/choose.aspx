<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="choose.aspx.cs" Inherits="CSWeb.Tablet_BIG2.choose" EnableSessionState="True" %>
...
<body id="cart">
    ...
    <!--#include file="header_cart.html"-->
        <div class="container_cart" style="padding: 24px 0 24px 22px;">
            ...
            <div class="chooseprod">
                <div class="text-center">
                    ...
                    <p class="text-center pad12">
                        <asp:LinkButton ID="lbComplete" runat="server" OnClick="lbComplete_Click"  CssClass="iblock btn_shadow_1"><img class="prod_continue block" src="//d1kg9stb0ddjcv.cloudfront.net/images/Tablet_BIG2/btn_continue.png" alt="Continue" /></asp:LinkButton>
                    </p>
                </div>
  ...
  <span style="display: inline-block;">‘The Joker is Wild’</span></li>
            ...
            <div class="chooseprod" style="margin: 0;">
                <div class="text-center">
                    ...
                    <div>
                        <img src="//d1kg9stb0ddjcv.cloudfront.net/images/Tablet_BIG2/flag_bestvalue.png" alt="Best Value" style="position:absolute;
top: 0; left: -25px;" />
                        <p class="text-center pad12">
                    ...
                    <p class="text-center pad20 f21"><strong>+</strong> <span class="f21 caps webfont1bold blue">FREE SHIPPING & HANDLING!</span></p>
                    <p class="text-center pad12">
                        <asp:LinkButton ID="lbSimple" runat="server" OnClick="lbSimple_Click"  CssClass="iblock btn_shadow_1"><img class="prod_continue block" src="//d1kg9stb0ddjcv.cloudfront.net/images/Tablet_BIG2/btn_continue.png" alt="Continue" /></asp:LinkButton>
                    </p>
                </div>
                
                <div class="bg_lavendergradient">
                    <img src="//d1kg9stb0ddjcv.cloudfront.net/images/Tablet_BIG2/prod_choose_2.png" alt="" class="block" style="margin-bottom: 30px;" />
