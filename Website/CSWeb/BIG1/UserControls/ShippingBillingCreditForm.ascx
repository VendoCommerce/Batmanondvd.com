<%@ Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.BIG1.UserControls.ShippingBillingCreditForm" CodeBehind="ShippingBillingCreditForm.ascx.cs" %>
                ...
                <tr>
                    ...
                    <asp:DropDownList ID="ddlShippingCountry" runat="server" DataTextField="NAME" DataValueField="COUNTRYID"
                                ...
                                <div class="form_line clearfix">
                                    ...
                                    <label class="label-1">
                                        Phone*</label>
                                    <asp:TextBox  AutoCompleteType="Disabled" ID="txtPhoneNumber1" runat="server" MaxLength="3" CssClass="text-4"></asp:TextBox>
