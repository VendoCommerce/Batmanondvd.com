<%@ Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.Tablet_COMPLETE.UserControls.ShippingBillingCreditForm" CodeBehind="ShippingBillingCreditForm.ascx.cs" %>
