...
<li><i class="icon-truck"></i> Shipping</li>
</ul>
<h3 class="page-header page-header-top">Shipping</h3>
...
<div class="push">
 <asp:HyperLink ID="HyperLink2" runat="server" CssClass="btn btn-primary" NavigateUrl="CustomShippingList.aspx"><i class="icon-pencil"></i> View Custom Shipping</asp:HyperLink>
</div>

    <div class="form-horizontal form-box">  
      <h4 class="form-box-header"> Shipping Options 
...
<asp:Label ID="lblCancel" runat="server" Text="Changes Cancelled!" Visible="false" CssClass="label label-important"></asp:Label></h4>
...
<div class="controls">  
   $ <asp:TextBox ID="txtFlat" runat="server" MaxLength="6" />
    ...
    <asp:UpdatePanel runat="server">
        <Triggers><asp:AsyncPostBackTrigger ControlID="cbRushShippingOption" /></Triggers>
        <ContentTemplate>
