<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TrackingPixels.ascx.cs" Inherits="CSWeb.Tablet_BIG3.UserControls.TrackingPixels" %>
<!-- All Pixels Here -->
...
<!-- End of DoubleClick Floodlight Tag: Please do not remove -->
    ...
    <script type="text/javascript"
            id="wa_u" defer></script><script type="text/javascript" async>                                         //<![CDATA[
                                         ...
                                         wa_MultivariateKey = <%=versionNameClientFunction %>;
