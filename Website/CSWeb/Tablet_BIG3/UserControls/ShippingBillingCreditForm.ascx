<%@ Control Language="C#" AutoEventWireup="true" Inherits="CSWeb.Tablet_BIG3.UserControls.ShippingBillingCreditForm" CodeBehind="ShippingBillingCreditForm.ascx.cs" %>
