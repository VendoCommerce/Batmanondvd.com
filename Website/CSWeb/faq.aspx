...
<div class="container">
    ...
    <div class="faq">
        <h4 class="bold f20 pad6">Lorem Ipsum Dolor Sit Amet</h4>
        <ul class="faq_qs">
        ...
        <dl>
            ...
            <dd>20 DVDs containing all 120 episodes (all three seasons on 17 DVDs) plus a bonus disc featuring over 3 hours of all new bonus features, the Adam West Naked DVD, and the original 1966 Batman Movie on DVD. You will also receive an extensive episode guide, a show script and a personalized letter from Adam West.  All this will be housed and packaged in your very own collectors box! This collection is available on DVD or Blu-Ray (the Blu-Ray will contain a total of 15 dvds). The Complete Classic Batman Collection is NOT sold at any stores and is only available at batmanondvd.com.</dd>

            <dt id="q4">Can I order more than one collection? </dt>
            <dd>For a limited time only, and as a special holiday offer, we are pleased to offer a 30% discount on each collection you order after the first one. Additional collections must be ordered at the same time as your initial purchase. We can also giftwrap your order for a nominal price.</dd>
